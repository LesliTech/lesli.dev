...
<div align="center">
    <a target="_blank" href="https://github.com/LesliTech/LesliBabel/actions">
...
<div align="center">
    <img
        ...
        alt="Lesli screenshot" src="/images/engines/babel/screenshot.png" />
</div>
...
git clone https://github.com/LesliTech/LesliBabel.git

# Load LesliBabel as a Gem
gem "lesli", path: "engines/LesliBabel"

# Install the necessary Gems to run LesliBabel
bundle install
