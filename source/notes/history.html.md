...
Also in **2019**, I started working with an investor from the other side of the ocean. The idea was to turn Lesli into a product that would be easy to distribute, install, maintain, and secure enough to support the operations of larger companies — a kind of federated software that could work across multiple companies.
...
My hope is to build something truly useful for others — something that can help people grow their businesses with software that is solid, well-designed, and built to last.

And that is why releasing Lesli as open source means so much to me.
It is not the beginning of the story. It is the result of more than a decade of work, changes, mistakes, and persistence.
