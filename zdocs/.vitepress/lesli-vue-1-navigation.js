...
export default [
    ...
    items: [
        ...
        { text: "Table",        link: "/lesli-css/1x/fonts" },
        { text: "Tabs",        link: "/lesli-css/1x/fonts" },
        { text: "Toggle",        link: "/lesli-css/1x/fonts" },
        { text: "Toolbar",        link: "/lesli-css/1x/fonts" },
    ]
}, {
    text: "Components",
    items: [
