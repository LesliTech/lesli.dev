...
// · ~·~     ~·~     ~·~     ~·~     ~·~     ~·~     ~·~     ~·~     ~·~
// · 
*/const f=m(),c=u,e=a,n=y(!1);function d(){return e.warning?"is-warning":e.success?"is-success":e.danger?"is-danger":e.info?"is-info":"is-primary"}const p=g(()=>{let s=["button",d()];return e.solid||(s.push("is-light"),s.push("is-outlined")),e.loading&&s.push("is-loading"),e.small&&s.push("is-small"),s});return B(()=>{!("default"in f)&&e.icon&&(n.value=!0)}),(s,i)=>(t(),l("button",{onClick:i[0]||(i[0]=C=>c("click")),class:o(p.value)},[a.icon?(t(),l("span",{key:0,class:o(["icon",{"is-small":a.small}])},[q("span",b,h(a.icon),1)],2)):r("",!0),n.value?r("",!0):(t(),l("span",v,[k(s.$slots,"default")]))],2))}};export{w as _};
