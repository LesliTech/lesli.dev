...
// · ~·~     ~·~     ~·~     ~·~     ~·~     ~·~     ~·~     ~·~     ~·~
// · 
*/const i=a,e=n;return r(()=>e.modelValue,(l,o)=>{i("change",e.modelValue)}),(l,o)=>(s(),t("label",m,[p("input",g(l.$attrs,{onInput:o[0]||(o[0]=V=>i("update:modelValue",!e.modelValue)),type:"checkbox",checked:e.modelValue,disabled:e.disabled}),null,16,y),p("span",_,[e.showText?(s(),t("div",b,[e.modelValue?(s(),t("p",f,h(e.enabledText),1)):(s(),t("p",v,h(e.disabledText),1))])):k("",!0)])]))}},T=c("",19);JSON.parse('{"title":"Toggle","description":"","frontmatter":{},"headers":[],"relativePath":"../../lesli-vue/source/elements/toggle/Toggle.md","filePath":"../../lesli-vue/source/elements/toggle/Toggle.md","lastUpdated":null}');const F={name:"../../lesli-vue/source/elements/toggle/Toggle.md"},q=Object.assign(F,{setup(n){const a=u(!1);return(i,e)=>(s(),t("div",null,[T,d(x,{modelValue:a.value,"onUpdate:modelValue":e[0]||(e[0]=l=>a.value=l)},null,8,["modelValue"])]))}}),P=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"vue/elements/toggle.md","filePath":"vue/elements/toggle.md","lastUpdated":1715574060000}'),C={name:"vue/elements/toggle.md"},A=Object.assign(C,{setup(n){return(a,i)=>(s(),t("div",null,[d(E(q))]))}});export{P as __pageData,A as default};
